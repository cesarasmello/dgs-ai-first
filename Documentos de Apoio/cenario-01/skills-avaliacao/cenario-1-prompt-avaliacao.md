...
|------|---------|----------------|
| **Skill Foundation** | Framework comum de avaliação (dimensões, escala, regras) | `skills-avaliacao/cenario-1-avaliacao-foundation.md` |
| **Skill do Papel** | Critérios específicos para o seu papel e exercício | `skills-avaliacao/cenario-1-avaliacao-product-specialist.md` |
