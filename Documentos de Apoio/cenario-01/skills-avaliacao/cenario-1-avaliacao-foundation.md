...
> **Dependências:** Usar em conjunto com `cenario-1-avaliacao-product-specialist.md` e `cenario-1-prompt-avaliacao.md`.
...
**Avaliação com IA:** Use o prompt padrão em `cenario-1-prompt-avaliacao.md`. Anexe esta Foundation + a skill do papel + o enunciado + o entregável.
